...
기본 노드 타입은 ADR-0018에서 `Start`, `Agent`, `End` 3종으로 확정되었다.
...
1. 기본 타입 기준을 ADR-0018에 단일화하면 중복 결정을 줄일 수 있다.
...
1. [ADR-0018-action-only-workflow-model.md](/Users/zayden.ok/Desktop/dev-others/agent-work/docs/adr/ADR-0018-action-only-workflow-model.md)
...
3. [ADR-0008-skill-json-schema-versioning-and-migration-policy.md](/Users/zayden.ok/Desktop/dev-others/agent-work/docs/adr/ADR-0008-skill-json-schema-versioning-and-migration-policy.md)
...
- Proposed -> Accepted 조건:
  ...
  3. (Satisfied) 신규 타입 ADR 승인 절차 합의
